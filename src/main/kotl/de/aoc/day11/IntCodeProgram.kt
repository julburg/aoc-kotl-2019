...
import de.aoc.day11.IntCodeProgram.OpCode.Companion.getOpCodeByIdentifier
...
class IntCodeProgram(private var codeList: LongArray) {
    ...
    fun run(inputValue: Long): OutputValue {
        val inputValues = InputValues(arrayListOf(inputValue))
